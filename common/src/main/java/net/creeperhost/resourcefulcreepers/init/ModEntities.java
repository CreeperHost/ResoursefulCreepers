...
public class ModEntities
{
    ...
    public static void loadCreeperTypes()
    {
        ...
        {
            EntityType<EntityResourcefulCreeper> entityType = EntityType.Builder.of(EntityResourcefulCreeper::new, MobCategory.MONSTER).sized(0.6F, 1.7F).clientTrackingRange(8).build(creeperType.getName());
            ENTITIES.register(creeperType.getName(), () -> entityType);
            if(creeperType.allowNaturalSpawns()) STORED_TYPES.put(entityType, creeperType.getSpawnWeight());
